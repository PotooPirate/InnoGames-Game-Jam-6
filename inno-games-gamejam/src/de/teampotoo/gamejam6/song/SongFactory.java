...
public class SongFactory {
	...
	public static ISong createSong1(IGameScreen gameScreen,
		...
		for (int i = 0; i < 1; i++) {
			beats.add(Beat.newInstance(BeatType.hard, beatCount * beatLength * 4, 0.3f, 0f, 0f));
			beatCount++;
		}
		for (int i = 0; i < 8; i++) {
			beats.add(Beat.newInstance(BeatType.medium, beatCount * beatLength * 4, 0.2f, 0f, 0f));
			beatCount++;
		}
		for (int i = 0; i < 8; i++) {
			beats.add(Beat.newInstance(BeatType.hard, beatCount * beatLength * 4, 0.3f, 0.2f, 0.3f));
			beatCount++;
		}
		for (int i = 0; i < 8; i++) {
			beats.add(Beat.newInstance(BeatType.hard, beatCount * beatLength * 4, 0.3f, 0.2f, 0f));
			beatCount++;
		}
		for (int i = 0; i < 4; i++) {
			beats.add(Beat.newInstance(BeatType.easy, beatCount * beatLength * 4, 0.1f, 0f, 0f));
		...
		for (int i = 0; i < 2; i++) {
			beats.add(Beat.newInstance(BeatType.ridiculus, beatCount * beatLength * 4, 0.3f, 1f, 0f));
			beatCount++;
		}
